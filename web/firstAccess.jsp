    ...
    <body>
        ...
        <div class="container my-5">
            ...
            <div class="card bg-dark mb-5">
                    ...
                    <div class="my-5 p-5 py-2">
                        ...
                        <form id="dbForm">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control bg-black text-white border-dark" id="driver" name="driver" placeholder="Driver" value="com.mysql.jdbc.Driver" required>
                                <label for="driver">Database driver</label>
                            </div>
                            
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control bg-black text-white border-dark" id="host" name="host" placeholder="Hostname" value="jdbc:mysql://localhost:3306/financeiro" required>
                                <label for="host">Database host</label>
                            </div>
                            
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control bg-black text-white border-dark" id="username" name="username" placeholder="Username" value="root" required>
                                <label for="username">Database username</label>
                            </div>
                            
                            <div class="form-floating mb-3">
                                <input type="password" class="form-control bg-black text-white border-dark" id="password" name="password" placeholder="Password" value="root">
                                <label for="password">Database password</label>
                            </div>
                            <div class="form-floating mb-3">
                                <button type="button" class="btn btn-light" id="testarConexao"><i class="fas fa-plug"></i> Testar conexao</button>
                ...
                <a href="firstAccess?action=finalize" class="btn btn-success disabled" id="finalize"><i class="fas fa-check"></i> Finalizar</a>
        ...
        <script>
            $(document).on("click", "#testarConexao", function() {
                ...
                var urlTotal = 'firstAccess?action=dbTest&driver='+driver+'&host='+url+'&username='+user+'&password='+pass;
                $.ajax({
                    type:'POST',
                    url: urlTotal,
            ...
            $(document).on("click", "#save", function() {
                ...
                var urlTotal = 'firstAccess?action=dbSave&driver='+driver+'&host='+url+'&username='+user+'&password='+pass;
                $.ajax({
                    type:'POST',
                    url: urlTotal,
                    success: function(res) {
            ...
            $(document).on("click", "#dbInstall", function() {
                ...
                var urlTotal = 'firstAccess?action=dbInstall';
                $.ajax({
                    type:'POST',
                    url: urlTotal,
                    success: function(res) {
            ...
            $(document).on("change", "#allowModalInfoOnLogin", function() {
                ...
                var urlTotal = 'firstAccess?action=update&AllowModalInfoOnLogin='+value;
                $.ajax({
                    type:'POST',
                    url: urlTotal,
                    success: function() {
            ...
            $(document).on("change", "#showAlertNegativeAccounts", function() {
                ...
                var urlTotal = 'firstAccess?action=update&ShowAlertNegativeAccounts='+value;
                $.ajax({
                    type:'POST',
                    url: urlTotal,
                    success: function() {
            ...
            $(document).on("change", "#allowAdminDeleteBankAcc", function() {
                ...
                var urlTotal = 'firstAccess?action=update&AllowAdminDeleteBankAcc='+value;
                $.ajax({
                    type:'POST',
                    url: urlTotal,
                    success: function() {
            ...
            $(document).on("change", "#allowAdminDeleteEntries", function() {
                ...
                var urlTotal = 'firstAccess?action=update&AllowAdminDeleteEntries='+value;
                $.ajax({
                    type:'POST',
                    url: urlTotal,

                        ...
                        <div class="d-flex text-muted pt-3">
                          ...
                          <div class="pb-3 mb-0 small lh-sm border-bottom w-100" ${applicationDarkTheme ? 'style="border-color: #1d2024 !important;"' : ''}>
                            <div class="d-flex justify-content-between">
                              ...
                              <span class="d-block"><input type="text" name="nome" value="${nome}" class="form-control ${applicationDarkTheme ? 'bg-black text-white border-dark' : ''}" oninput="changeTitle(this.value)" maxlength="20" required/></span>
                          </div>
                        </div>
                        <div class="d-flex text-muted pt-3">
                          ...
                          <div class="pb-3 mb-0 small lh-sm border-bottom w-100" ${applicationDarkTheme ? 'style="border-color: #1d2024 !important;"' : ''}>
                            <div class="d-flex justify-content-between">
                              ...
                              <input type="text" class="form-control mascara-cpf ${applicationDarkTheme ? 'bg-black text-white border-dark' : ''}" id="cpf" value="${cpf}" name="cpf" maxlength="14" oninput="validateCPF(this.value)" required />

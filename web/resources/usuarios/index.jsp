...
<html ${applicationDarkTheme ? '' : 'style="background-color: #efefef !important;"'}>
    ...
    <body ${applicationDarkTheme ? '' : 'style="background-color: #efefef !important;" class="text-dark"'}>
        ...
        <jsp:include page="../../assets/components/modal/novoUser.jsp" />
        ...
        <c:if test="${applicationDarkTheme}">
            <script>
                ...
                $(document).on("change", "#admin", function() {
                    if($("#admin").is(':checked')) {
                        $("#adminLabel").removeClass("bg-black");
                        $("#userLabel").addClass("bg-black");
                    }
                });

                $(document).on("change", "#user", function() {
                    if($("#user").is(':checked')) {
                        $("#userLabel").removeClass("bg-black");
                        $("#adminLabel").addClass("bg-black");
                    }
                });
            </script>
        </c:if>
